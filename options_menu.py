...
def show_options(hacker_alias, hacker_id):
    ...
    while(True):
        ...
        try:
            ...
            # If the hacker wants to view their own exploits, call the function and pass the hacker's username and id as arguments
            elif(selection == 2):
                owner_exploits.view_my_exploits(hacker_alias, hacker_id)
            # If the hacker wants to modify their exploits, call the function pass the hacker's username and id as arguments
            elif(selection == 3):
                modify_exploits.modify_my_exploits(hacker_alias, hacker_id)
            # If the hacker wants to view other exploits, call the function and pass the hacker's id as an argument
            elif(selection == 4):
            ...
            # If the hacker wants to leave the site, print a message and break the loop
                ...
                # If the hacker enters a number that is not between 1 and 5, print an error message and prompt the hacker to enter their selection again
